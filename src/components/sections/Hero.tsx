  ...
  return (
    <section className="relative pt-32 lg:pt-36  ">
      <Container className = "flex flex-col lg:flex-row gap-10 lg:gap-12"> 
        ...
        blur-xl opaci ty-60 lg:opacity-95 lg:block  hidden"
         >
        </span>
        <span className="absolute right-4 bottom-12 w-24 h-24 rounded-3xl bg-primary blur-xl opacity-80 "></span>
        </div>
        <div className="relative flex flex-col items-cemter text-center lg:text-left lg:py-8 
           lg:items-start lg:max-w-none max-w-3xl mx-auto lg:flex-1 lg:w-1/2">
            ...
            Empower Your Business
             <span className="text-transparent bg-clip-text bg-gradient-to-r
              ...
              <div className="mt-10 w-full flex max-w-md mx-auto lg:mx-0" >
                ...
                shadow-box-shadow border border-box-border bg-box-bg  
